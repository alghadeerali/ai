  ...
  return <div className="flex min-h-[100dvh] w-full overflow-hidden bg-background text-foreground">
    ...
    <main className="flex min-w-0 flex-1 flex-col overflow-hidden">
      <div className="md:hidden sticky top-0 z-20 flex h-14 items-center justify-between border-b border-border bg-background px-3">
        ...
        <div className="min-w-0 flex-1 px-2 text-center"><div className="truncate text-base font-bold tracking-tight">{id ? (conversation?.title || 'محادثة جديدة') : 'محادثة جديدة'}</div><div className="truncate text-[11px] text-muted-foreground">alghadeer ai</div></div>
