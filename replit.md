...
- النشر على Render (Docker) + Neon Postgres — استضافة مجانية بالكامل، بدون أي تكلفة
- دعم كامل للعربية وRTL
- الثيم الافتراضي: **فاتح** (مع إمكانية التبديل لداكن أو حسب النظام)
- زر Enter: قابل للتخصيص من الإعدادات (إرسال أو سطر جديد)
- المايك: تحويل صوت لنص مجاناً عبر المتصفح (Web Speech API)
